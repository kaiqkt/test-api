...
val excludePackages: List<String> by extra {
    listOf(
        "com/kaiqkt/testapi/Application*",
        "com/kaiqkt/testapi/application/config/*",
        "com/kaiqkt/testapi/application/web/requests/*",
        "com/kaiqkt/testapi/application/web/responses/*",
        "com/kaiqkt/testapi/domain/models/*",
        "com/kaiqkt/testapi/domain/dtos/*",
        "com/kaiqkt/testapi/domain/utils/*",
    )
}
